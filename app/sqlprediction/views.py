...
from app.sqlprediction.models import BlockedHost, PacketInfo
from app.sqlprediction.serializers import UploadedFileSerializer
from .serializers import *
from rest_framework.decorators import api_view, permission_classes, action
from rest_framework.permissions import *
from rest_framework.decorators import *
from django.views.decorators.csrf import csrf_exempt
from .models import predict_few
from rest_framework import status, permissions
from rest_framework.response import Response
from django.http import HttpResponse, JsonResponse
import numpy as np
from app.dumped_models.load_models import load_model, load_joblib
from django.shortcuts import render
from rest_framework.views import APIView
from rest_framework.response import Response
...
class PacketInfoViewSet(viewsets.ModelViewSet):
    queryset = PacketInfo.objects.all()
    serializer_class = PacketInfoSerializer


class BlockedHostViewSet(viewsets.ModelViewSet):
    queryset = BlockedHost.objects.all()
    serializer_class = BlockedHostSerializer
...
class PredictSQLInjection(APIView):
    ...
    @swagger_auto_schema(request_body=PredictSQLInjectionSerializer)
    def post(self, request, format=None):
        serializer = PredictSQLInjectionSerializer(data=request.data)
